      ...
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 py-6 rounded-lg shadow-lg">
        <p className="text-lg text-white text-justify sm:text-left ">
          <p>
            ...
            Pakistan. With an unwavering commitment to excellence, we strive to
            ensure that businesses, offices, and commercial spaces remain not
            just clean but also hygienic, safe, and welcoming for employees,
            customers, and visitors. Our comprehensive cleaning solutions are
            tailored to meet the diverse needs of various industries, including
            corporate offices, hospitals, educational institutions, shopping
            malls, industrial facilities, and many more. Whether it&apos;s
            routine janitorial services, deep cleaning, disinfecting, carpet and
            upholstery cleaning, or specialized industrial cleaning, our expert
            team is equipped with the latest tools, eco-friendly cleaning
            products, and industry-best practices to deliver outstanding
            results.
          </p>
          ...
          <p>
            ...
            guaranteeing impeccable service and customer satisfaction. We take a
            proactive approach to cleaning, customizing our services to fit the
            specific requirements of our clients, whether they need daily,
            weekly, or on-demand cleaning solutions.
          </p>

          <p>
            One of our core values is reliability, and we believe in maintaining
            long-term relationships with our clients by consistently delivering
            high-quality cleaning services. Our dedication to customer
            satisfaction means that we listen to our clients&apos; needs,
            respond promptly to their concerns, and continuously improve our
            services to exceed expectations. With a strong focus on using
            environmentally friendly and sustainable cleaning methods, we ensure
            that our practices not only enhance the cleanliness of your
            workspace but also contribute positively to a greener planet.
          </p>
          ...
          <p>
            ...
            goal is to create a space that fosters productivity, enhances brand
            reputation, and promotes the well-being of everyone who enters.
            Choose Clean Care for professional, efficient, and top-quality
            cleaning services across Pakistan, and experience the difference of
            a spotless, healthier, and more inviting workspace.
          </p>
        </p>
        {/* Why Choose Us Section */}
        <h2 className="text-2xl md:text-3xl text-green-400 font-semibold mt-6 text-center">
          Why Choose Clean Care?
        </h2>
        {/* Features List */}
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-6 mt-12">
          ...
          <div className="flex flex-col gap-6">
            <div className="p-6 shadow-lg rounded-2xl bg-white">
              ...
              <p className="text-left text-base text-gray-600 font-normal">
                We provide exceptional service and engage in proactive behavior.
              </p>
            </div>
            <div className="p-6 shadow-lg rounded-2xl bg-white md:mt-16">
              <Image
              ...
              <p className="text-left text-base text-gray-600 font-normal">
                We strive for the highest standards and continuously improve in
